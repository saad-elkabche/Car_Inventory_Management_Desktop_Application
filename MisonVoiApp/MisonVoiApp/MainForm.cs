...
namespace MisonVoiApp
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            Forms.homaPage frm = new Forms.homaPage();
            open_form(frm, btnHome);
        }
        ...
        {
            Forms.Achat frm = new Forms.Achat();
            open_form(frm,btnAchat);
        }
        ...
        private void btnAdmin_Click(object sender, EventArgs e)
        {
            ...
            clickedButton(btnAdmin);
            Forms.admin frm = new Forms.admin();
            frm.StartPosition = FormStartPosition.CenterScreen;
            frm.ShowDialog();
            if (currentBtn != null)
                clickedButton(currentBtn);
